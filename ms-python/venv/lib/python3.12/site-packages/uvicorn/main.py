...
puerto_desarrollo = int(os.getenv("PORT_DESARROLLO", 3000))  # Puerto de desarrollo por defecto
puerto_produccion = int(os.getenv("PORT_PRODUCCION", 4000))  # Puerto de producción por defecto
...
@click.option(
    "--port",
    type=int,
    default=puerto_desarrollo if entorno_env == "desarrollo" else puerto_produccion,
